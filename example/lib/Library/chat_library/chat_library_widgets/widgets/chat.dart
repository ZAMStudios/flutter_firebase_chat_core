import 'dart:math';
import 'package:example/Library/chat_library/chat_library_widgets/chat_l10n.dart';
import 'package:example/Library/chat_library/chat_library_widgets/chat_theme.dart';
import 'package:example/Library/chat_library/chat_library_widgets/conditional/conditional.dart';
import 'package:example/Library/chat_library/chat_library_widgets/models/date_header.dart';
import 'package:example/Library/chat_library/chat_library_widgets/models/emoji_enlargement_behavior.dart';
import 'package:example/Library/chat_library/chat_library_widgets/models/message_spacer.dart';
import 'package:example/Library/chat_library/chat_library_widgets/models/preview_image.dart';
import 'package:example/Library/chat_library/chat_library_widgets/models/send_button_visibility_mode.dart';
import 'package:example/Library/chat_library/chat_library_widgets/util.dart';
    ...
    if (object is DateHeader) {
      return Container(
        ...
        child: Padding(
          ...
          child: Text(
            object.text,
            style: const TextStyle(color: Color(0xff848484),fontSize: 10),
          ),
        ),
      );
